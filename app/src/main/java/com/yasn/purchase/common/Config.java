...
//    //欢迎界面图片
    ...
    //查看物流
    public final static String ORDERLOOKDISTR = IP+"order/deliverys/";
    ...
    //订单提醒
    public static final String ORDERHURRY =  IP+"order/hurry/";
    //确认收货
    public static final String ORDERCONFIRM =  IP+"order/rogConfirm/";
    //待付款
