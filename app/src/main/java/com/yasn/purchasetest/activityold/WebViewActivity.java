...
import com.yasn.purchasetest.utils.CommonHelper;
import com.yasn.purchasetest.utils.MyWebChromeClient2;
import com.yasn.purchasetest.utils.ReadImgToBinary;
import com.yasn.purchasetest.utils.SerializableUtil;
import com.yasn.purchasetest.utils.ToastUtil;
import com.yasn.purchasetest.video.activity.PlayActivity;
import com.yasn.purchasetest.wxapi.WXPay;
    ...
    public void setCookie(Context context, String url, String value) {
        try {
            ...
            if (cookies.indexOf("JavaShopUser")==-1){
                ...
                Log.e("TAG_WEBCookie5=====", "setCookie()=="+cookie);
...
//    }
    ...
    private void removeCookie(Context context) {
        Log.e("TAG_WEBCookie",  "removeCookie");
        CookieSyncManager.createInstance(context);
