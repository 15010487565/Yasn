...
import com.yasn.purchasetest.adapter.ShopCarAdapter;
import com.yasn.purchasetest.common.Config;
import com.yasn.purchasetest.help.ShopCarUtils;
import com.yasn.purchasetest.listener.OnShopCarClickListener;
import com.yasn.purchasetest.model.EventBusMsg;
import com.yasn.purchasetest.model.ShopCarAdapterModel;
import com.yasn.purchasetest.model.ShopCarModel;
import com.yasn.purchasetest.model.ShopCarWholeModel;
...
//        linearLayoutManager.setAutoMeasureEnabled(true);
    ...
    private void initImageStoreNameSelect() {
        ...
        for (int i = 0, j = shopCarAdapterList.size(); i < j; i++) {
            ...
            int itmeType = shopCarAdapterGood.getItmeType();
            String beforeSale = shopCarAdapterGood.getBeforeSale();//是否余艘
            ...
            for (int i = 0, j = data.size(); i < j; i++) {
                ...
                if (goodslist != null && goodslist.size() > 0) {
                    ...
                    for (int k = 0, l = goodslist.size(); k < l; k++) {
                        ...
                        //相同店铺选中个数
                        if (isCheck == 1) {
                            storeCheckPrice = storeCheckPrice + price * num;
                        }
                        //库存
